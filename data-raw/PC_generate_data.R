...
PC_trials[doubleton_names[1:choose(n_objects, 2)]] =
  t(apply(PC_trials[c('set_bin', 'choice_int')], 1,
...
PC_demographics =
  tibble(sex = as.factor(sex_names[PC_raw[subj_seq, 'gender']]),
...
PC_table = table(PC_trials[c('domain', 'set_bin', 'choice_int')])

# Dimension naming for PC_counts
