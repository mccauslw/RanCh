...
get_scalars <- function(exper) {
  ...
  n_groups <- length(exper$ind_ln_marl$gr_marl)
  result <-
    c(mm_marl = exper$max_min_ln_marl,
      unifP_marl = exper$uniform_P_ln_marl,
      P_maxl = exper$P_maxl$ln_maxl,
      pi_maxl = exper$pi_maxl$ln_maxl,
      ind_marl = mean(exper$ind_ln_marl$gr_cum_ln_marl),
      ind_marl_nse = sd(exper$ind_ln_marl$gr_cum_ln_marl)/sqrt(n_groups),
      ...
      ind_t = unname(exper$ind_time[3]),
      rp_t = unname(exper$rp_time[3]),
      pi_t = unname(exper$pi_maxl_time[3]),
      ind_al_mu = exper$ind_alpha_stats$mu,
      ind_al_nse = exper$ind_alpha_stats$nse,
      ind_al_rne = exper$ind_alpha_stats$rne,
...
table_vars <- c('exper', 'ind_al_mu', 'ind_al_nse', 'ind_al_rne',
...
table_vars <- c('exper', 'pi_t', 'ind_t', 'rp_t')
digits <- c(0, 2, 2, 2)
