...
print(log_ML_DCE_uniform(N))
print(log_ML_DCE_uniform_mult(N))
# One parameter models
print(log_ML_DCE_scalar_alpha_Dir_mult(2.0, N))
# n-parameter models
print(log_ML_DCE_vector_alpha_Dir_mult(c(1.0, 2.0, 1.0, 2.0, 1.0), N))
```
